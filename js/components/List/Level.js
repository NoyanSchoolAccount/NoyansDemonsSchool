    ...
    template: `
        <div class="level">
            <div class="copy-container">
                ...
                <Copy v-if="!copied" @click="copyURL('https://noyansdemonslist.vercel.app/#//level/' + level.path); copied = true"></Copy>
                <Copied v-if="copied" @click="copyURL('https://noyansdemonslist.vercel.app/#//level/' + level.path); copied = true"></Copied>
            </div>
