...
export default {
    ...
    template: `
        <div class="tier" style="height: 100%; justify-content: center; align-items: center;">
            ...
            <p style="padding-top:1.5rem">The levels {{ descending ? 'below' : 'above' }} are {{ ["beginner", "easy", "medium", "hard", "insane", "mythical", "extreme", "supreme", "ethereal", "legendary", "hard", "impossible"][level.difficulty] }} levels.</p>
